...
AccountReport.sendFiles=  function()
{
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200 ) {
            ...
            $('#loadingBar').hide();
            $('#fileStatus').hide();
            AccountReport.Submit(currentButton);
        } else {
    ...
    xhr.open('POST', "Home/SendFiles?PageName=AccountReport");
    // xhr.setRequestHeader("Content-type", "multipart/form-data");
    xhr.send(data);
}


AccountReport.Submit= function(obj)
{
    currentButton=obj;
    $(obj).attr('disabled',true);
    if(AccountReport.Validate()==false)
    {
...
AccountReport.Validate= function()
{
...
AccountReport.Serach=function(obj)
{
    $(obj).attr('disabled',true);
    if(AccountReport.Validate()==false)
    {
    ...
    window.CurrentSerachMethod=AccountReport.Serach;
    var Entity=new Object();
    Entity.PageName='AccountReport';
    Entity.Parameters=new Array();
                Entity.Parameters.push( toInput('AccId',$('#txtAccountReportAccId').val()));
