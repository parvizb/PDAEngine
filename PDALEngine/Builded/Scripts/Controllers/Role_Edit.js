...
Role_Edit.sendFiles=  function()
{
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200 ) {
            ...
            $('#loadingBar').hide();
            $('#fileStatus').hide();
            Role_Edit.Submit(currentButton);
        } else {
    ...
    xhr.open('POST', "Home/SendFiles?PageName=Role_Edit");
    // xhr.setRequestHeader("Content-type", "multipart/form-data");
    xhr.send(data);
}


Role_Edit.Submit= function(obj)
{
    currentButton=obj;
    $(obj).attr('disabled',true);
    if(Role_Edit.Validate()==false)
    {
...
Role_Edit.Serach=function(obj)
{
    ...
    window.CurrentSerachMethod=Role_Edit.Serach;
    var Entity=new Object();
    Entity.PageName='Role_Edit';
    Entity.Parameters=new Array();
                Entity.Parameters.push( toInput('RoleId',routeParams.RoleId ));
