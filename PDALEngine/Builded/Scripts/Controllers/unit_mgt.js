...
TableViewAjax('getTableViewRecords',Entity,function(data){
    ...
    currentScope.unit_mgtrecords= data.records;
    
    setTimeout(StoreCache, 200);
    currentScope.$apply(function(){});
    if(dlgScope!=null)
    {
        dlgScope.unit_mgtrecords= data.records;
...
unit_mgt.InsertRecord=function()
{
    ...
    temp.rndId = Math.round(Math.random() * 99999999999999);
        currentScope.unit_mgtrecords.push(temp);
    currentScope.$apply();
...
{
    Validator.ClearErrors();
                                                                                                    if(typeof ( currentScope.unit_mgtrecords)!="undefined") {
    for (var l=0;l<currentScope.unit_mgtrecords.length;l++)
{
    var r=currentScope.unit_mgtrecords[l];
...
for(var l=0;l<currentScope.unit_mgtrecords.length;l++)
{ 
    var record=currentScope.unit_mgtrecords[l];
